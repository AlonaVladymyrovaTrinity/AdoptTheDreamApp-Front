  ...
  return (
    <Card className={`mb-4 ${style['custom-card']}`}>
      ...
      <Card.Body>
        ...
        <Card.Text className={`${style['card-text']} ${isExpanded ? style['expanded'] : ''}`}>{description}</Card.Text>
...
const team = [
  ...
  { name: 'Luba', role: 'Frontend Team', image: require('../../../images/Luba.jpg'), description: 'Liubov is originally from Russia but moved to USA North Carolina in 2014. She has two master degrees in Physics and Finance and worked in the Finance field before moving to the US. After seven years as a stay-at-home mom, Liubov had a hard time navigating the workforce. After some research she decided to try herself in software development. And now Liubov loves to be a part of Code the Dream family. ' },
  { name: 'Anna', role: 'Frontend Team', image: require('../../../images/Anna.jpg'), description: '  Anna is from Russia. She moved to the US in 2013 to North Carolina. She has a bachelor’s degree in finance from Russia and her previous work experience was in finance. Having moved to the USA, Anna devoted herself completely to caring for her family, since it was during this period that she became a mother for the first time. After some time, I started to study programming, and finished the bootcamp, where I mastered HTML, CCC and Java Script. Anna started looking at various educational resources and found Code The Dream. When she joined the CTD team, she realized that CTD offered everything she needed: structured learning materials, the perfect blend of theory and practice, and tremendous support from mentors and teammates. Every day Anna moves towards her dream of becoming a Software Developer. She has made learning an important part of her daily life and follows the concept of lifelong learning and growing mindset. Anna is a devoted wife and mother of two wonderful children. In addition, she enjoys boxing and loves to travel with her family.' },

...
import FillingApplicationFormButton from '../Adoption/FillingApplicationFormButton';
        ...
        <Container style={{ width: '80%' }}>
          ...
          >
            <Row xs={1} md={1} lg={2} xl={2} className="ms-1 me-1">
              ...
              <Col md={8}>
                <p>
                  Tell us briefly, in your own words, why you want to bring a
                  pet into your home:*
                </p>
              </Col>
              <Row className="mb-3">
              ...
              <Col md={8}>
                <p>
                  How many hours during a typical day will the pet be left
                  alone?*
                </p>
              </Col>
              <Row className="mb-3">
              ...
              <Col md={8}>
                <p>
                  If you can no longer care for pet , who will contact our
                  rescue to return pet? Please include their name, address, and
                  phone number.*
                </p>
              </Col>
              <Row className="mb-3">
              ...
              <Row className="mb-3">
                <Form.Group>
                  <Form.Select
                    ...
                    onChange={(e) =>
                      setSelectedPetsBeenPoisoned(e.target.value)
                    }
              ...
              <Row className="mb-3">
                <Form.Group>
                  <Form.Select
                    ...
                    onChange={(e) =>
                      setSelectedGivenPetToShelter(e.target.value)
                    }
            ...
            <div className="ms-5">
              <p>
                If you do not have a vet, please include three personal
                references above.
              </p>
              <p>
                I agree that if I am permitted to adopt, I will have the
                adoptive pet checked by my own veterinarian within 7 days of
                said adoption, and will provide medical care, at my own expense,
                as well as routine yearly exams for as long as I own the pet. I
                understand and agree that giving false information in response
                to any of the questions above will disqualify me from adopting a
                pet, and will nullify all adoption(s) and/or adoption
                agreements.
              </p>
              <Form.Group className="mb-3">
                <Form.Check

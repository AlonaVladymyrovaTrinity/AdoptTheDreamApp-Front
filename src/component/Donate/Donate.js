          ...
          <div className={style['main-donation-box']}>
            <div className={style['donation-text-container']}>
              ...
              <div className={style['card-body-text']}>
                ...
                <h3 className={style['donation-h3']}>
                  {' '}
                  Make a Difference Today!
                </h3>
                <p>
                  Your gift to the animals at Adopt Pet has the power to save
                  lives. By making a contribution, you directly support our
                  mission of helping thousands of animals in need.
                </p>
                <p>
                  Every dollar you donate goes straight to work, providing
                  essential care, nourishment, and medical attention to animals
                  awaiting their forever homes. Your generosity ensures that
                  these animals receive the love and support they deserve during
                  their journey to finding a loving family.
                </p>
              </div>
            </div>
            <div className={style['donation-container']}>
              ...
              <div className={style['donation-card-body-text']}>
                <p>
                  By donating today, you become a hero for animals in distress.
                  Your compassion and support can transform their lives and give
                  them a second chance at happiness. Together, we can create a
                  world where every animal is valued and cherished.
                </p>
